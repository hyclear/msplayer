...
CC_IDENT=Apple LLVM version 7.3.0 (clang-703.0.31)
ARCH=aarch64
INTRINSICS=neon
...
CFLAGS=  -arch arm64 -miphoneos-version-min=7.0 -fembed-bitcode -std=c99 -fomit-frame-pointer -fPIC -pthread -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Os -fno-math-errno -fno-signed-zeros -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
CXXFLAGS= -arch arm64 -miphoneos-version-min=7.0 -fembed-bitcode -D__STDC_CONSTANT_MACROS
OBJCFLAGS=  
ASFLAGS=  -arch arm64 -miphoneos-version-min=7.0 -fembed-bitcode -fPIC -g -Qunused-arguments
AS_C=-c
AS_O=-o $@
OBJCC_C=-c
OBJCC_E=-E -o $@
...
DOXYGEN=doxygen
LDFLAGS= -arch arm64 -miphoneos-version-min=7.0 -fembed-bitcode  -Wl,-dynamic,-search_paths_first -Qunused-arguments
LDEXEFLAGS=
LDLIBFLAGS=
