...
- (UIView *)addVideoView:(CGRect)rect
{
    ...
    [glView setHudValue:nil forKey:@"scheme"];
    [glView setHudValue:nil forKey:@"host"];
    [glView setHudValue:nil forKey:@"path"];
    [glView setHudValue:nil forKey:@"ip"];
    [glView setHudValue:nil forKey:@"http"];
    [glView setHudValue:nil forKey:@"tcp-spd"];
    
    [_glViewArray addObject:glView];
    
    //增加view到c++层
    ijkmp_ios_add_glview(_mediaPlayer, glView);
...
{
    ijkmp_ios_remove_glview(_mediaPlayer, (IJKSDLGLView *)view);
    
    [_glViewArray removeObject:view];
}
...
- (void)setMute:(BOOL)mute
{
    ...
    ijkmp_set_mute(_mediaPlayer, mute);
}
...
- (BOOL)mute{
    ...
    return ijkmp_get_mute(_mediaPlayer) ? YES : NO;
}
...
- (float)volume
{
    ...
    return ijkmp_get_volume(_mediaPlayer);
}
