...
//    [liveView addSubview:self.player.view];
    [self.view addSubview:self.mediaControl];
    
//    UIView *subView = [[UIView alloc]initWithFrame:CGRectMake(300, 0, 200, 200)];
//    
//    [self.view addSubview:subView];
//    UIView *subVideoView = [self.player addVideoView:subView.frame];
//    //[self.player removeVideoView:subVideoView];
//    [subView addSubview:subVideoView];
//    
...
- (IBAction)onClickCurVolume:(id)sender {
...
- (IBAction)onClickVolumeUp:(id)sender {
    [self.player setVolume:(self.volume += 2)];
    NSLog(@"setVolume %f", self.volume);
}

- (IBAction)onClickVolumeDown:(id)sender {
    [self.player setVolume:(self.volume -= 2)];
    NSLog(@"setVolume %f", self.volume);
}
